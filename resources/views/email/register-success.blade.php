...
<body style="word-spacing:normal;background-color:#bedae6;">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td align="center" style="font-size:0px;padding:0 25px;word-break:break-word;">
                                <div style="font-family:Arial;font-size:18px;line-height:1;text-align:center;color:#000000;">Email Anda telah terdaftar di Buku KAS ASI<br> Silahkan login dengan menggunakan password:</div>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td align="center" style="font-size:0px;padding:0 25px;padding-top:40px;word-break:break-word;">
                                <div style="font-family:Arial, sans-serif;font-size:14px;line-height:1;text-align:center;color:#000000;">Best regards, <br> Pengelola ASI EXT <p></p>
                                </div>
                              </td>
                            </tr>
                          </tbody>
